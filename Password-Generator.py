...
photo = PhotoImage(file="E:\\My Data Science full for job - Copy\\Project Practice for Placements\\Day-01\\Beginner-Python-Projects-main\\Password Genetator\\password.png")
